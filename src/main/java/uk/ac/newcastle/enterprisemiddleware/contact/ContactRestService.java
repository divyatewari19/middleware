...
public class ContactRestService {
     ...
     */
    @GET
    @Operation(summary = "Fetch all Contacts", description = "Returns a JSON array of all stored Contact objects.", hidden = true)
    ...
    @POST
    @Operation(description = "Add a new Contact to the database", hidden = true)
    @APIResponses(value = {
    ...
    @PUT
    @Path("/{id:[0-9]+}")
    @Operation(description = "Update a Contact in the database", hidden = true)
    @APIResponses(value = {
    ...
    @DELETE
    @Path("/{id:[0-9]+}")
    @Operation(description = "Delete a Contact from the database", hidden = true)
    @APIResponses(value = {
